...
class CrmCustomerSegmentsSeeder extends Seeder
{
    ...
    private function seedProfiles(): void
    {
        ...
        $alberto = $this->createCustomer([
            ...
            'email_marketing_consent_at' => $now->copy()->subMonths(4),
        ...
        $lucia = $this->createCustomer([
            ...
            'email_marketing_consent_at' => $now->copy()->subMonths(10),
        ...
        $valerio = $this->createCustomer([
            ...
            'email_marketing_consent_at' => $now->copy()->subMonths(3),
        ...
        $anna = $this->createCustomer([
            ...
            'email_marketing_consent_at' => $now->copy()->subMonths(5),
        ...
        $marta = $this->createCustomer([
            ...
            'email_marketing_consent_at' => $now->copy()->subMonths(6),
