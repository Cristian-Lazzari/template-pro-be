...
<body style="font-family: Arial, sans-serif; background-color: #e9f0fb; color: #161c3e; margin: 0; padding: 10px 0px 0px; width: 100%;">
   ...
   @endphp
    <img style="width: 80px; margin: 2rem; filter: drop-shadow( 0 0 15px rgba(5, 1, 31, 0.496)); " src="{{config('configurazione.APP_URL') . '/public/favicon.png'}}" alt="">
    ...
    <p style="color: #04001d; font-size: 22px; text-align: center; margin: .6rem 20px">{{$content_mail['ending']}}</p>
