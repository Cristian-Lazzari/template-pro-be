...
<body style="font-family: Arial, sans-serif; background-color: #e9f0fb; color: #161c3e; margin: 0; padding: 10px 5px;">
   <!-- Footer -->
   @php
       $locale = 'it_IT';
   ...
   @endphp
    ...
    <h1 style="color: #04001d; font-size: 28px; padding: 5px;">{{$content_mail['heading']}}</h1>
    
    @if($content_mail['img_1'] !== NULL)   
    <img src="{{$content_mail['img_1']}}" alt="">
    @endif
    
    <div style="margin: 1rem 2rem; font-size: 20px;" class="corpo">
    ...
    <footer style="width: 100%; margin: 50px 0 0; background-color: black; color: white; padding: 10px; text-align: center; font-size: 12px;">
        ...
        <div style="display: flex; gap: 10px; justify-content:center; aline-items: center; flex-wrap: wrap">
                ...
                <a style="display: flex; gap: 3px;" href="https://www.facebook.com/profile.php?id=61558817374447"> <span>Future plus</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                      <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                    </svg>
                </a>
                <a style="display: flex; gap: 3px;" href="https://www.instagram.com/future.plus_/?hl=it"> <span>@future.plus_</span>
        ...
        <p style="font-size: 12px; line-height: 1.5; margin: 5px;" > Powered by <a style="color: white" href="https://future-plus.it">Future +</a></p>
    </footer>
</body>
</html>
