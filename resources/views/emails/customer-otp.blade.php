...
<body style="margin:0; padding:0; background:#f5f7fb; font-family:Arial, Helvetica, sans-serif; color:#1e2d64;">
    <div style="max-width:560px; margin:0 auto; padding:32px 16px;">
        <div style="background:#ffffff; border-radius:20px; padding:32px 24px; box-shadow:0 12px 30px rgba(0,0,0,.08);">
            <p style="margin:0 0 12px; font-size:14px; letter-spacing:.08em; text-transform:uppercase; color:#10b793;">{{ __('customer.mail.eyebrow') }}</p>
            <h1 style="margin:0 0 16px; font-size:28px; line-height:1.2;">{{ __('customer.mail.title') }}</h1>
            <p style="margin:0 0 24px; font-size:16px; line-height:1.6;">
                {{ __('customer.mail.intro') }}
            </p>
