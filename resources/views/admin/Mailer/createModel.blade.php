    ...
    <section class="base">
        ...
        <div class="split"> 
            <div>
                ...
                <i class="bi bi-type"></i>{{ __('admin.Nome_del_modello_') }}</label>   
            ...
            <div>
                <label class="label_c" for="sender">
                <i class="bi bi-type"></i>{{ __('admin.Mittente_') }}</label>   
        ...
        <p class="desc"> 
            ...
            <i class="bi bi-type"></i>{{ __('admin.Oggetto_mail_') }}</label>   
        ...
        <p class="desc"> 
            ...
            <i class="bi bi-type"></i>{{ __('admin.Heading_') }}</label>   
        ...
        <p class="desc"> 
            ...
            <i class="bi bi-body-text"></i>{{ __('admin.Conclusione_1') }}</label>   
