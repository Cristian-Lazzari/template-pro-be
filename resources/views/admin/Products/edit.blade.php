        ...
        <div class="split">
            ...
            <div>
                <label class="label_c" for="price">   
                    ...
                    Prezzo</label>
                <p>€<input @if(!isset($data)) value="{{  $product->price / 100 }}" @else value="{{ $data['price'] / 100}}" @endif  step="0.01" type="number" name="price" id="price" placeholder=" inserisci il prezzo "></p>
