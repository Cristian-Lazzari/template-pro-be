...
<form class="top-bar-product" action="{{ route('admin.posts.filter') }}" method="post">
    ...
    <div class="bar">
        ...
        <div class="buttons">
         ...
         <a class="my_btn search" href="{{ route('admin.posts.index')}}">
...
<div class="action-page">
    <a class="my_btn create m-1 w-auto" href="{{ route('admin.posts.create') }}">Crea un nuovo post</a>
    <a class="my_btn trash m-1 w-auto" href="{{ route('admin.posts.archived') }}">Archivio</a>
</div>
