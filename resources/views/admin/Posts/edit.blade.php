...
<form class="creation"  action="{{ route('admin.posts.update' , $post) }}"  enctype="multipart/form-data"  method="POST">
    ...
    <h1 class="mb-5">Modifica il Post</h1>
    ...
    <section class="base">
        ...
        <p class="desc"> 
            ...
            <div class="collapse" id="desc">
                <p>
                    Per andare a capo riportare i caratteri: <strong>/**/</strong> , per mettere in grassetto del testo invece basta racchiudere la porzione di testo che si vuole mettere in grassetto tra 3 asterischi in questo modo: <strong>*** parola da mettere in grassetto ***</strong> 
                </p>
            </div>
