    ...
    <section class="base">
        ...
        <div class="split">
            <div>
                ...
                <p><input value="{{ old('place', $post->place) }}" type="text" name="place" id="place" placeholder=" inserisci un luogo "></p>
            ...
            <div>
                ...
                <p><input value="{{ old('date', $post->date) }}" type="date" name="date" id="date" ></p>
        ...
        <div class="check_c">
            ...
            <p>
                @foreach($categories as $category)
                    ...
                    value="{{ $category->id }}"
                    @if(in_array($category->id, old('categories', $post->categories->flatten(1)->unique('id')->toArray(), [])))
                        checked
                    @endif>
